-- Script pour créer les tables manquantes et insérer les données
...
-- Insert sample stocks (sans seuil_alerte)
insert into stocks (nom, categorie, quantite, unite, prix_unitaire, fournisseur) values
  ('Provenda Poules', 'Aliment', 250, 'kg', 450, 'COPAZ'),
  ('Maïs moulu', 'Aliment', 180, 'kg', 350, 'Local'),
  ('Sel minéral', 'Complement', 25, 'kg', 2000, 'Veto'),
  ('Vaccin Newcastle', 'Veterinaire', 50, 'doses', 1500, 'SEN-CRV'),
  ('Antiparasitaire', 'Veterinaire', 30, 'doses', 2500, 'SEN-CRV'),
  ('Engrais compost', 'Intrant', 500, 'kg', 100, 'Production eigene'),
  ('Semences maïs', 'Intrant', 20, 'kg', 800, 'ONG Agriculture'),
  ('Fongicide bio', 'Intrant', 15, 'L', 3500, 'Bioferme');
...
-- =============================================
-- Insert data into existing animals table
-- =============================================
...
-- =============================================
-- Insert data into existing parcelles table
-- =============================================
